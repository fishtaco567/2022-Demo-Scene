...
namespace SharpNoise {
    ...
    /// <summary>
    /// Generates grid-based Voronoi Noise
    /// </summary>
    public class Voronoi {

        /// <summary>
        /// Distance metric for the voronoi
        /// </summary>
        public enum DistanceMetric {
            /// <summary>
            /// Normal sqrt(sum((x_n_1 - x_n_0)^2)) distance
            /// </summary>
            EUCLIDEAN,
            /// <summary>
            /// Taxicab sum(|x_n_1 - x_n_0) distance
            /// </summary>
            TAXICAB,
            /// <summary>
            /// max(|x_n_1 - x_n_0) distance
            /// </summary>
            CHEBYSHEV
        }
        ...
        /// <summary>
        /// Create a Voronoi generator with the given seed and metric
        /// </summary>
        /// <param name="seed">The seed to generate the point distribution</param>
        /// <param name="metric">The distance metric used to characterize the space</param>
        public Voronoi(int seed, DistanceMetric metric) {
        ...
        /// 1D Voronoi Noise
        /// </summary>
        /// <returns>A value from -1 to 1 representing the region the point is in</returns>
