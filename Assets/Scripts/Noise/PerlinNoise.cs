namespace SharpNoise {
    ...
    /// <summary>
    /// Generator for classic perlin (gradient) noise. Note: each dimension of noise has a different output range. This is fixable but is common to all implementations of perlin noise
    /// </summary>
    public class PerlinNoise {
        ...
        /// <summary>
        /// Create a new PerlinNoise with the given seed
        /// </summary>
        /// <param name="seed">The seed to generate the perm table</param>
        public PerlinNoise(uint seed) {
            var rand = new SRandom(seed);
            ...
            for(int i = 0; i < REPITITION_SIZE; i++) {
                int toSwitch = rand.RandomIntLessThan(REPITITION_SIZE);
        ...
        /// </summary>
        /// <returns>Smooth noise from -1 to 1</returns>
        public float GetNoise1D(float x) {
            ...
            float c1 = (x - 1) * GRADIENT_1D[perm[xGridPoint + 1] & PERMUTATION_MASK_1D];
        ...
        /// </summary>
        /// <returns>Smooth noise from -2 to 2</returns>
        ...
        /// </summary>
        /// <returns>Smooth noise from -3 to 3</returns>
